...
public interface ISuplenciaService {
	double CalculaImporteSuplencia(String quincena, String clave_empleado, int dias, String tipo, int riesgos);
	double CalculaImporteSuplencia(String quincena, DatosEmpleado empleado, int dias, String tipo, int riesgos);
	int GuardarSuplencia(DatosSuplencia suplencia, double importe, DatosEmpleado empleado) throws SQLException;
