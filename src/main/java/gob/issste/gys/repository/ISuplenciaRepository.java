...
//												+ "    UPDATE SET estatus1 = 1, id_usuario1 = ?, fec_validacion = CURRENT YEAR TO SECOND";
	public String STMT_UPDATES_AUTH_STATUS_1 	= "MERGE INTO gys_autorizacion_suplencias AS A\r\n"
												+ "USING (\r\n"
												...
												+ "    	INNER JOIN gys_autorizacion_suplencias A\r\n"
												+ "        ON A.id_suplencia = S.id\r\n"
												+ "		WHERE A.estatus1 = 0\r\n"
												+ "			AND A.id_tipo = ? \r\n"
												+ " 		AND S.fec_paga = ?\r\n"
	...
	int updateAuthStatusSuplencias1(String tipo, String fec_pago, String idDeleg, String idDeleg1,int idUsuario);
...
//												+ "    UPDATE SET estatus1 = 1, id_usuario1 = ?, fec_validacion = CURRENT YEAR TO SECOND";
	...
	public String STMT_UPDATES_AUTH_STATUS_1ext = "MERGE INTO gys_autorizacion_suplencias AS A\r\n"
												+ "USING (\r\n"
												+ "		SELECT S.id, S.id_centro_trabajo, C.id_area_generadora, A.estatus1, A.id_tipo, S.fec_paga\r\n"
												...
												+ "		A.id_usuario1 = ?,\r\n"
												+ "		A.fec_validacion = CURRENT YEAR TO SECOND";
	int updateAuthStatusSuplencias1Ext(String tipo, String fec_pago, String idDeleg, String idDeleg1,int idUsuario);
...
//												+ "    UPDATE SET estatus2 = 3, id_usuario2 = ?, fec_autorizacion = CURRENT YEAR TO SECOND";
	...
	public String STMT_UPDATES_AUTH_STATUS_2 	= "MERGE INTO gys_autorizacion_suplencias AS A\r\n"
												+ "USING (\r\n"
												+ "		SELECT S.id, S.id_centro_trabajo, C.id_area_generadora, A.estatus1, A.id_tipo, S.fec_paga\r\n"
												+ "		FROM gys_suplencias_emp S\r\n"
												+ "		INNER JOIN m4t_centros_trab C\r\n"
	...
	int updateAuthStatusSuplencias2(String tipo, String fec_pago, String idDeleg, String idDeleg1, int idUsuario);
...
//												+ "WHEN MATCHED THEN\r\n"
//												+ "    UPDATE SET estatus2 = 3, id_usuario2 = ?, fec_autorizacion = CURRENT YEAR TO SECOND";
public String STMT_UPDATES_AUTH_STATUS_2ext = "MERGE INTO gys_autorizacion_suplencias AS A\r\n"
											+ "USING (\r\n"
											+ "		SELECT S.id, S.id_centro_trabajo, C.id_area_generadora, A.estatus1, A.id_tipo, S.fec_paga\r\n"
											+ "		FROM gys_suplencias_ext S\r\n"
											+ "		INNER JOIN m4t_centros_trab C\r\n"
