...
public interface IBolsaTrabajoRepository {
	...
	public String QUERY_ADD_BOLSA_TRABAJO			= "INSERT INTO gys_bolsatrabajo (rfc, nombre, apellidopat, apellidomat, idDelegacion, codigo_postal, curp, id_beneficiario, consecutivo ) \r\n"
													+ "Values (?, ?, ?, ?, ?, ?, ?, ?, ?)";
	...
	public String QUERY_UPD_BOLSA_TRABAJO			= "Update gys_bolsatrabajo \r\n"
													...
													+ "idDelegacion=?, codigo_postal=?, curp=?, id_beneficiario =?, consecutivo = ? \r\n"
													+ "Where id = ?";
	...
	public String QUERY_GET_BOLSA_TRABAJO			= "Select b.id id, b.rfc rfc, b.nombre nombre, b.apellidopat apellidopat, b.apellidomat apellidomat, d.id_div_geografica, n_div_geografica,\r\n"
													+ "codigo_postal, curp, id_beneficiario, consecutivo\r\n"
