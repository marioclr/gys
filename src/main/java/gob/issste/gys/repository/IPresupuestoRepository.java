...
public interface IPresupuestoRepository {
	...
	public String QUERY_ADD_PRESUPUESTO_CT		    = "INSERT INTO gys_presupuesto (anio, idDelegacion, id_centro_trabajo, idTipoPresup, saldo)\r\n"
			+ "Values ( ?, ?, ?, ?, ? )";
	...
	public String QUERY_GET_PRESUPUESTO_BY_TYPE_CT  = "Select P.id, P.anio, P.saldo, P.idDelegacion, D.n_div_geografica,\r\n"
													+ "NVL(P.id_centro_trabajo, '00000') id_centro_trabajo, P.idTipoPresup, T.clave, T.descripcion\r\n"
													+ "From gys_presupuesto P, gys_tip_presupuesto T, m4t_delegaciones D\r\n"
													+ "Where P.idTipoPresup=T.id And P.idDelegacion=D.id_div_geografica\r\n"
													...
													+ "  And P.idTipoPresup = ?\r\n"
													+ "  And P.anio = ?";
	Presupuesto getElementByType_ct(String idCentroTrab, Integer idTipo, Integer anio);
	...
	List<Presupuesto> get_dynamic_regs(String idDelegacion, Integer idTipoPresup, Integer anio, String idCentTrab, boolean solo_deleg);
