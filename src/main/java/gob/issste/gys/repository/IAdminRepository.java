...
public interface IAdminRepository {
	...
	public String QUERY_CONSULTA_LAYOUT_SPEP_REP = "Select A.rfc, A.nombre, A.apellidoPat, A.apellidoMat, A.id_beneficiario, A.consecutivo,\r\n"
												...
												+ "      From gys_guardias_ext GE, m4t_puestos_plaza PU, m4t_centros_trab C, m4t_delegaciones D, m4t_area_generadora A, gys_fechas_control F, gys_presupuesto P, gys_presupuesto_prog PR\r\n"
												...
												+ "        And GE.id IN (Select id_guardia From gys_autorizacion_guardias Where estatus2=3)\r\n"
												...
												+ "      From gys_suplencias_ext SE, m4t_puestos_plaza PU, m4t_centros_trab C, m4t_delegaciones D, m4t_area_generadora A, gys_fechas_control F, gys_presupuesto P, gys_presupuesto_prog PR\r\n"
												...
												+ "        And P.id = PR.idpresupuesto\r\n"
												+ "        And PU.id_empresa = '01' And PU.id_sociedad = '01'\r\n"
												+ "        And SE.id IN (Select id_suplencia From gys_autorizacion_suplencias Where estatus2=3)\r\n"
												+ "      Group By rfc, D.id_div_geografica, fec_paga\r\n"
												+ "  ) SE\r\n"
												+ "  ON IMP.rfc = SE.rfc\r\n"
